...
class Output_335_CurrentSource(BaseOutput):
    """
...
class Output_335_VoltageSource(BaseOutput):
    """
    Class for control outputs 3 and 4 of model 335 that are variable DC voltage
    sources
    """
...
class Model_335_Channel(BaseSensorChannel):
...
class Model_335(LakeshoreBase):
    ...
    def __init__(self, name: str, address: str, **kwargs) -> None:
        ...
        #self.output_3 = Output_335_VoltageSource(self, 'output_3', 3)
        #self.output_4 = Output_335_VoltageSource(self, 'output_4', 4)
